        ...
        <>
            <div className="w-full h-[284px] flex justify-between">
                ...
                <div className="w-[350px] h-full flex flex-col justify-end">
                    <div className="w-full h-[204px] flex flex-col justify-end items-center bg-theme-light-grey rounded-lg relative">
                        ...
                        <div className="w-full h-[58px] text-center mb-[30px]">
                            ...
                            <div className="flex justify-center items-center">
                                <span className="text-[13px] tracking-[1px] uppercase font-bold opacity-50">Shop</span>

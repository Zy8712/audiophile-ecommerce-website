...
function ProductCardImageRight(props) {

    return (
        <>
            <div className={`w-full ${props.newProduct ? 'h-[724px] sm:h-[706px]' : 'h-[681px] sm:h-[671px]'} lg:h-[560px] flex flex-col-reverse lg:flex-row justify-between items-center transition-all duration-500 ease-in-out`}>
...
export default ProductCardImageRight;